...
def predict_game_results():
    ...
    for team_info in team_comparison_results:
        ...
        print("rank_diff_status",rank_diff_status)
        # Generate the game result based on the classifications
        result, rule_number = generate_result(a_team_class, b_team_class, a_recent_group, b_recent_group, rank_diff_status)
...
if __name__ == "__main__":
    game_results = predict_game_results()

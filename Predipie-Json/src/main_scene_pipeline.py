...
from match_pipeline_prediction import MatchPredictionPipeline
def run_all_pipelines(api_url):
    """Run all pipelines to generate outputs for scene2, scene3, scene4, scene5, and scene6 in separate folders."""
    ...
    # اجرای خط لوله برای scene6
    print("Processing Scene 6...")
    scene6_pipeline = MatchPredictionPipeline(api_url, folder_name='scene6')
    scene6_pipeline.process()

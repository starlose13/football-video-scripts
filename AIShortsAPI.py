...
def generate_video_script(game_data, prediction_result, row_number):
    ...
    Write the output from the ({long_form_output}) in a more explicit and attractive way. Also, randomly change it to make the output reckless.But it should not be longer than 3000 characters
